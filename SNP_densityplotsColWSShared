...
##Looking at Col, Shared Col and WS02, Shared Col and WS2
...
SNP_densityplot <- function(table1, table2, table3, ymax, poslist, lablist, Title) {
  ...
  plot(table2, xaxt='n', xlab = "Chromosome Position", ylab= "", ylim=c(0, ymax), col= "Orange", type="h")
  axis(1, at=poslist, labels=F)
  text(poslist, labels=lablist, par("usr")[1] -100, srt=20, pos = 1, xpd=T) 
  plot(table3, xaxt='n', xlab= "", ylab= "", ylim=c(0, ymax), col= "chocolate4", type="h")
  axis(1, at=poslist, labels=F)
  text(poslist, labels=lablist, par("usr")[1] -100, srt=20, pos = 1, xpd=T) 
...
#For Col WS02 Shared
#Load file as variable
WS02_Chr1 <- read.delim("ColWS02Shared_Chr1pos.txt")
#Use Binning function
...
#For Col WS2 Shared
#Load file as variable
WS2_Chr1 <- read.delim("ColWS2Shared_Chr1pos.txt")
#Use Binning function
...
#For Col WS02 Shared
#Load file as variable
WS02_Chr2 <- read.delim("ColWS02Shared_Chr2pos.txt")
#Use Binning function
...
#For Col WS2 Shared
#Load file as variable
WS2_Chr2 <- read.delim("ColWS2Shared_Chr2pos.txt")
#Use Binning function
...
#For Col WS02 Shared
#Load file as variable
WS02_Chr3 <- read.delim("ColWS02Shared_Chr3pos.txt")
#Use Binning function
...
#For Col WS2 Shared
#Load file as variable
WS2_Chr3 <- read.delim("ColWS2Shared_Chr3pos.txt")
#Use Binning function
...
#For Col WS02 Shared
#Load file as variable
WS02_Chr4 <- read.delim("ColWS02Shared_Chr4pos.txt")
#Use Binning function
...
#For Col WS2 Shared
#Load file as variable
WS2_Chr4 <- read.delim("ColWS2Shared_Chr4pos.txt")
#Use Binning function
...
#For Col WS02 Shared
#Load file as variable
WS02_Chr5 <- read.delim("ColWS02Shared_Chr5pos.txt")
#Use Binning function
...
#For Col WS2 Shared
#Load file as variable
WS2_Chr5 <- read.delim("ColWS2Shared_Chr5pos.txt")
#Use Binning function
